...
import { auth, getUserProfile, updateUsername, UserProfile } from "../firebase";
import { CogIcon, UserIcon, SunIcon, MoonIcon } from "@heroicons/react/24/solid";
...
const Settings: React.FC = () => {
  ...
  const [activeTab, setActiveTab] = useState<'profile' | 'appearance' | 'game'>('profile');
  ...
  if (loading) {
    return (
      <div className="p-6 max-w-4xl mx-auto text-center">
        ...
        <p className="mt-4 text-zinc-600 dark:text-zinc-400">Loading settings...</p>
      </div>
    );
  }
  ...
  return (
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="flex border-b border-gray-200 dark:border-zinc-700 mb-6">
        ...
        >
          {darkMode ? (
            <MoonIcon className="h-5 w-5 inline-block mr-2" />
          ) : (
            <SunIcon className="h-5 w-5 inline-block mr-2" />
          )}
          Appearance
        </button>
        <button
          ...
          <form onSubmit={handleSaveGamePreferences}>
              ...
              <div className="space-y-2">
                <label className="flex items-center space-x-3">
                  <input
                    ...
                    onChange={() => handleGamePreferenceChange("defaultGameMode", "individual")}
                ...
                <label className="flex items-center space-x-3">
                  <input
                    ...
                    onChange={() => handleGamePreferenceChange("defaultGameMode", "teams")}
                    className="h-4 w-4 text-blue-600"
                  />
            ...
            <div className="mb-6">
              ...
              <select
                ...
                onChange={(e) => handleGamePreferenceChange("defaultPointsToWin", parseInt(e.target.value))}
            ...
            <div className="mb-6">
              <label className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) => handleGamePreferenceChange("useBoricuaRules", e.target.checked)}
                  className="h-4 w-4 text-blue-600"
                />
                <span className="text-sm font-medium">Use Boricua (Puerto Rican) Rules by default</span>
              </label>
            </div>
            ...
            <div className="mb-6">
              <label className="flex items-center space-x-2">
                <input
                  ...
                  onChange={(e) => handleGamePreferenceChange("confirmationReminders", e.target.checked)}
                  className="h-4 w-4 text-blue-600"
                />
                <span className="text-sm font-medium">Send reminders for game confirmations</span>
              </label>
            </div>
