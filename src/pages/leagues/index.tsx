...
import { TrophyIcon, PlusIcon, UserGroupIcon, ClockIcon, MagnifyingGlassIcon } from "@heroicons/react/24/solid";
    ...
    const fetchLeagues = async () => {
      ...
      try {
        ...
        if (auth.currentUser) {
          ...
          const leagueIds = membershipSnapshot.docs.map(doc => doc.data().leagueId);
    ...
    <div className="p-6 max-w-6xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {myLeagues.map(league => (
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="text-lg font-semibold mb-1 truncate">{league.name}</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-2 truncate">{league.description}</p>
      ...
      <div>
        <h2 className="text-xl font-semibold mb-4">
          {filter === 'all' ? 'All Leagues' : 
           filter === 'active' ? 'Active Leagues' :
           filter === 'upcoming' ? 'Upcoming Leagues' : 'Completed Leagues'}
        </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredLeagues.map(league => (
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="text-lg font-semibold mb-1 truncate">{league.name}</h3>
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-4 line-clamp-2">{league.description}</p>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex space-x-2">
                      ...
                      {!myLeagues.some(myLeague => myLeague.id === league.id) && (
                        <Link
