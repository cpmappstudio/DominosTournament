...
export function Sidebar({ className, ...props }: React.ComponentPropsWithoutRef<'nav'>) {
  return <nav {...props} className={clsx(className, 'flex h-full min-h-0 flex-col text-white')} />
}
...
export const SidebarItem = forwardRef(function SidebarItem(
  ...
  const classes = clsx(
    ...
    '*:data-[slot=icon]:size-6 *:data-[slot=icon]:shrink-0 *:data-[slot=icon]:fill-white sm:*:data-[slot=icon]:size-5',
